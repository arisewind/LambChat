...
// 538KB：批量创建/导入模型对齐最新 ModelConfigCreate 结构（逐条添加补全
// icon/价格覆盖/视觉开关/行级 API 覆盖 + JSON 导入文件上传与规范化，五语 8 键）
// 把 eager JS 顶到约 537.3KB，沿 2KB 阶梯惯例累加抬档
// （此前 #563/#565/#612/#613 及排队消息编辑的抬档史见 git log）。

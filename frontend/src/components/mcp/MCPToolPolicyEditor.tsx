...
export function MCPToolPolicyEditor({
  ...
  return (
    <div className="es-field">
      ...
      {error && (
        <div className="mt-2 rounded-lg border border-red-200 bg-red-50 px-3 py-2 text-12 text-red-600 dark:border-red-800/40 dark:bg-red-950/20 dark:text-red-400">
          {error}
        </div>
      )}
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2">
                    <code className="truncate text-12 font-semibold text-stone-700 dark:text-stone-200">
                      {tool.name}
                    </code>

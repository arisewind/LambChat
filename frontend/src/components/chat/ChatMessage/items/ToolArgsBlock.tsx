...
const sizeClasses: Record<ToolArgsBlockSize, string> = {
  detail:
    "tool-args-block group/args relative flex items-center gap-2 px-3 py-2 rounded-[var(--radius-sm)] bg-theme-bg-card text-sm text-theme-text-tertiary font-mono",
  compact:
    "tool-args-block group/args relative flex items-center gap-2 mb-2 px-2 py-1.5 rounded-[var(--radius-sm)] bg-theme-bg-card text-xs text-theme-text-tertiary font-mono",
};

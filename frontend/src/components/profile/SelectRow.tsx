...
export function SelectRow<T extends string>({
  ...
  return (
    <>
      ...
      >
        <span className="text-sm text-theme-text dark:text-stone-200">
          {label}
        </span>
        <span className="flex items-center gap-1 text-xs text-theme-text-secondary dark:text-stone-400">
          {loading ? (
          ...
          >
            ...
            >
              <div className="px-5 pt-4 pb-2">
                <h4 className="text-sm font-semibold font-serif text-theme-text dark:text-stone-100">
                  {label}
                </h4>
              </div>
              ...
              <div className="border-t border-theme-border-subtle dark:border-stone-700/50 px-5 py-3">
                <button
                  onClick={onToggle}
                  className="w-full text-center text-xs font-medium text-theme-text-secondary dark:text-stone-400 hover:text-theme-text dark:hover:text-stone-200 transition-colors"
                >
                  {t("common.cancel")}
                </button>
              </div>

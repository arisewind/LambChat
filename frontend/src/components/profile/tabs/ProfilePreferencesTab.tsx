  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-2xl bg-theme-bg-subtle dark:bg-stone-700/40 p-4 border border-theme-border dark:border-stone-600/40">
        ...
        <div className="rounded-xl bg-theme-bg-card dark:bg-stone-700/50 p-3.5 sm:p-4">
      ...
      <div className="rounded-2xl bg-theme-bg-subtle dark:bg-stone-700/40 p-4 border border-theme-border dark:border-stone-600/40">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg border border-theme-border dark:border-stone-600/60 px-3 py-1.5 text-xs font-medium text-theme-text-secondary dark:text-stone-300 hover:bg-theme-bg-card dark:hover:bg-black/20 transition-colors"
          >
            <RefreshCw size={12} />

    ...
    <ToolResultPanel
      ...
      footer={
        <div className="px-3 sm:px-5 py-2 sm:py-3 border-t border-[var(--theme-border)] bg-[var(--theme-primary-light)]">
          <div className="flex items-center justify-between text-12 sm:text-12 text-[var(--theme-text-secondary)]">
            <div className="flex items-center gap-1.5 sm:gap-2 min-w-0 flex-1">
              <span className="font-medium text-[var(--theme-text-secondary)] hidden xs:inline">
                {state.t("documents.path")}:
              </span>
              <span className="font-serif text-[var(--theme-text)] truncate text-12 sm:text-12">
                {state.path}
              </span>
            </div>
